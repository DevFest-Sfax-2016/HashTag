 ...
 */
public class UpdateRobeTask extends AsyncTask<String,Integer,Boolean> {
    Context context;
    Robe tmpRobe;
    private ProgressDialog pBar;
    private boolean statuts;

    public UpdateRobeTask(Context context, Robe tmpRobe) {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        JSONObject json = jParser.makeHttpRequest("http://"+ HostServer.IP+"/RestAPI.svc/UpdateRobe/"+tmpRobe.getNumrobe()+"/"+tmpRobe.getDesignation()+"/"+tmpRobe.getPrixtotal(),"GET", data);
