 ...
 */
public class UpdateClientTask extends AsyncTask<String,Integer,Boolean> {
    Context context;
    Client tmpClient;
    private ProgressDialog pBar;
    private boolean statuts;

    public UpdateClientTask(Context context, Client tmpClient) {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        JSONObject json=jParser.makeHttpRequest("http://"+ HostServer.IP+"/RestAPI.svc/UpdateClient/"+tmpClient.getCin()+"/"+tmpClient.getNomclient()+"/"+tmpClient.getAdresse()+"/"+tmpClient.getTelephone(),"GET",data);
    ...
    protected void onPostExecute(Boolean statuts) {
        ...
        {
            Toast.makeText(context,"Error Update",Toast.LENGTH_LONG).show();
        }
    }
}
